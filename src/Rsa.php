...
class Rsa
{
    ...
    private $_hashAlg = OPENSSL_ALGO_SHA256;
    ...
    public function sign($dataString)
    {
        $this->setupPrivKey();
        $signature = false;
        openssl_sign($dataString, $signature, $this->_privKey,$this->_hashAlg);
    ...
    public function verify($dataString, $signString)
    {
        ...
        $flg = openssl_verify($dataString, $signature, $this->_pubKey,$this->_hashAlg);
        return $flg;
    }
